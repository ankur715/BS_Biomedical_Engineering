...
% Last Modified by GUIDE v2.5 18-Oct-2012 13:38:32
...
axis tight;
set(handles.text1,'String','Attack of the Sine Wave');
...
plot(x,y);
axis tight;
set(handles.text1,'String','Attack of the Cosine Wave');
